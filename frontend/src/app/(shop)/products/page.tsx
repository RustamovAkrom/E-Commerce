...
export default function ProductsPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 px-4 py-10 animate-slide-up">
      <div>
        <h1 className="text-3xl font-bold">Mahsulotlar</h1>
        <p className="text-muted-foreground">
          Katalogdan kerakli mahsulotni toping.
        </p>
      </div>
      <ProductFilters
        value={filters}
      ...
      {categories.error && (
        <p className="text-sm text-destructive">
          Kategoriyalar yuklanmadi: {categories.error.message}
        </p>
      )}
      <ProductGrid
